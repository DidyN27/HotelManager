    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientReservation", x => new { x.ClientsClientID, x.ReservationsReservationId });
                    table.ForeignKey(
                        name: "FK_ClientReservation_Clients_ClientsClientID",
                        column: x => x.ClientsClientID,
                        principalTable: "Clients",
                        principalColumn: "ClientID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientReservation_Reservations_ReservationsReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientReservation_ReservationsReservationId",
